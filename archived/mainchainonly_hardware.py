## this is part of the original code, using Qiskit Nature. This will not be able to submit to
## actual hardware if your environment is made of Qiskit Research only
## Hakan and I are currently trying to figure out how to run hardware jobs using Qiskit runtime
## and primitives
...
IBMQ.load_account()
IBMQ.providers()
provider = IBMQ.get_provider(hub='ibm-q-ccf', group='cleveland-access', project='qperf')
...
#backend_name = least_busy(small_devices)
...
plt.ylabel("Conformation Energy")
plt.xlabel("VQE Iterations")
plt.savefig("conf_energy_plot_hardware.png", dpi=300,transparent=False)
#plt.show()
##
...
#fig.show()
fig.savefig("3dcrd_hardware.png", dpi=300,transparent=False)
##
