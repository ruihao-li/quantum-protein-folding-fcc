system("pwd")
setwd("/home/radivot/GH/protein-folding-qc/res/tom/amber/BCC16")
...
system("echo $PATH")
system("$AMBERHOME/bin/tleap -s -f leapB16.in > leapB16.out")
...
system(s) #"grep 18922 ../*.out"
1936000/500 # frame 3872 in file 4

setwd("/home/radivot/GH/protein-folding-qc/res/tom/amber/BCC16") 
system("$AMBERHOME/bin/cpptraj TC5b.prmtop < extract_frame4.trajin > extract_frame4.out")
...
system("$AMBERHOME/bin/cpptraj TC5b.prmtop <average_42-50_crd.cpptraj")
system("vmd equil_average_42-50.pdb")  ## same (still bad)
