system("pwd")
setwd("/home/radivot/GH/protein-folding-qc/res/tom/amber/trp19") 
system("pwd")
...
d%>%ggplot(aes(x=t,y=E))+geom_line()
d%>%filter(E==min(E)) 
system("grep 19448 ../*.out")
2199000/500 # frame 4398
...
system("$AMBERHOME/bin/cpptraj TC5b.prmtop <average_19_crd.cpptraj")
