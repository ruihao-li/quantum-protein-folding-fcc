...
run(session, 'open pdbs/FCC/fits/fcc5.pdb') # my best FCC = 1.212
...
run(session, 'open pdbs/CUB/fits/cub5.pdb') # my best CUB = 1.928 
...
run(session, 'open pdbs/FCC/LatFitFCC.pdb') # latfit's FCC = 1.55297
...
run(session, 'open pdbs/CUB/LatFitCUB.pdb') # latfit's CUB = 1.90779
...
run(session, 'open pdbs/BCC/fits/bcc2.pdb') # my best BCC = 1.441
...
run(session, 'open pdbs/DIA/fits/dia2.pdb') # my best DIA = 2.991   
