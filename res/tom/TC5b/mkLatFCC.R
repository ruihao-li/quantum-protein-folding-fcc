...
# before 9A x 6 was 54 A across 6x6x6 cube, here go with 10*5.4=54 at end
y <- replicate(x, a.ind = 0:10, b.ind = 0:10, c.ind = 0:10)
y$conect <- conect(y,safety=4)
visualize(y)
write.pdb(y,"pdbs/FCC/LatFCC.pdb")
write_tsv(y$conect,"pdbs/FCC/conFCC.txt",col_names=F)
