...
run(session, 'close')
run(session, 'open ../TC5b/pdbs/BCC/LatBCC.pdb')
...
S=list()
f = open("../TC5b/pdbs/BCC/conBCC.txt", "r")
import re
for x in f:
  y=x.strip()
...
# FCC   1.421, 1.431, 1.104, 1.35,  1.424, 1.144, 1.582, 1.596
# BCC   1.689, 1.495, 1.52,  1.414, 1.32,  1.374, 1.342, 1.585
# CUB   1.369, 1.878, 1.43,  2.059, 1.739, 1.962, 1.739, 1.962
# DIA   1.88,  1.936, 2.529, 2.273, 2.273, 2.135, 2.135, 2.135
