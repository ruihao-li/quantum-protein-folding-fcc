...
run(session, 'open pdbs/CUB/cub2.pdb') 
...
run(session, 'open pdbs/BCC/bcc6.pdb') 
run(session, 'style #4 sphere')
run(session, 'color #4 green')
run(session, 'size #4 atomRadius 0.25')
run(session, 'align #4 to #1 move chains')[2]

run(session, 'open pdbs/FCC/fcc4.pdb') 
run(session, 'style #5 sphere')
run(session, 'color #5 blue')
run(session, 'size #5 atomRadius 0.25')
run(session, 'align #5 to #1 move chains')[2]
