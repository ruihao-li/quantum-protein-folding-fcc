...
setwd("~/GH/protein-folding-qc/res/tom/pulchra")

for (i in c("DIA","CUB","BCC","FCC")) 
  for (j in 2:9) {
     # i="DIA"
     # j=2
    system(paste0("pulchra -v ../chigLat/pdbs/",i,"/",tolower(i),j,".pdb")) 
    system(paste0("mv ../chigLat/pdbs/",i,"/",tolower(i),j,".rebuilt.pdb pdbChig/",i,j,".pdb")) 
  } 
